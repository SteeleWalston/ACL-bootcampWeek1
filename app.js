...
console.log ('Right! My name is ' + name + '!');
...
if ((married.toLowerCase() === 'y') ||  (married.toLowerCase() === 'yes')) {
    ...
    alert('Unfortunately, ' + name + ', you missed another one... but keep going, no one\'s perfect! ;)');
}
...
if ((iceCream.toLowerCase() === 'y') || (iceCream.toLowerCase() === 'yes')) {
    alert('Of course, ' + name + '. I mean, who DOESN\'NT like ice cream, right? :)');
}
else if ((iceCream.toLowerCase() === 'n') || (iceCream.toLowerCase() === 'no')) {
    alert('You were doing so well, ' + name + '... well, maybe next question you\'ll get back to class?');
}
